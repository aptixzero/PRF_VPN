...
- Latest release: [Professor VPN v9.5](https://github.com/aptixzero/my_prFF_vP_N/releases/latest)
...
`ProfessorVPN-v9.5-universal.apk`

```text
SHA-256  63b432523644a5bede7b24ca29c6606a6113002a6a2796bb3a4d35c09b0b4dc4
```
