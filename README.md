...
- Latest release: [Professor VPN v8.8](https://github.com/aptixzero/my_prFF_vP_N/releases/latest)
...
`ProfessorVPN-v8.8-universal.apk`

```text
SHA-256  e67a006b48636e2d1cff5c80901f238d9c16f36225f62a0433661d14595e860a
```
